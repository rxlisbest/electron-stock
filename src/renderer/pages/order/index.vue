    ...
    <template slot="body">
      <el-row>
        <el-col :span="18">
          <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item :to="{ name: 'order-index' }">列表</el-breadcrumb-item>
          </el-breadcrumb>
        </el-col>
      </el-row>
      ...
      <el-table
        ...
        <el-table-column
          ...
          label="操作">
          <template slot-scope="scope">
            <el-button @click="open({name: 'order-detail', query: {id: scope.row.id}})" type="primary" icon="el-icon-tickets" circle></el-button>
          </template>
        </el-table-column>
      </el-table>
